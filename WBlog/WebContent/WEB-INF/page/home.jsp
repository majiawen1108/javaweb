			...
			<div class="list1">
				<c:forEach var="obj" items="${ list }" varStatus="st">
					<div class="view">
						...
						<a href="blog-drop.do?blogId=${ obj.blogId }"><img alt="删除" src="static/css/img/close.png" style="width:30px;height:30px;margin-left:553px;margin-top:-35px;"></a>
						</p>
						<p>${ obj.blogContent }</p>						
						...
						<div style="float:left;margin-left:5px;">(${ obj.thumb })</div> 
